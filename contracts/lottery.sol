...
// Enter the lottery (paying come amount)
// pick a randome winner(verifyabli random)
// Winner to be selected every x minutes =>  Completly autmated
 ...
 * @dev This implements the Chainlink VRF Version 2 and Chainklink Automation
 */
...
contract Lottery is VRFConsumerBaseV2, AutomationCompatibleInterface {
     ...
     * 2. The Lotterry should have at least 1 player, and have some ETH
